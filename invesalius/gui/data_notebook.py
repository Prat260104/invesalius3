...
BTN_NEW, BTN_REMOVE, BTN_DUPLICATE, BTN_OPEN, BTN_IMPORT_MASK, BTN_EXPORT_MASK, BTN_EXPORT_SURFACE = (
...
class SurfaceButtonControlPanel(wx.Panel):
    ...
    def OnExportSurface(self):
        ...
        from invesalius.gui.task_exporter import WILDCARD_SAVE_3D, INDEX_TO_TYPE_3D, INDEX_TO_EXTENSION
